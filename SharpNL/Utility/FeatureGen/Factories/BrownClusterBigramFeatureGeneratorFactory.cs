...
namespace SharpNL.Utility.FeatureGen.Factories {
    ...
    /// </summary>
    internal class BrownClusterBigramFeatureGeneratorFactory : XmlFeatureGeneratorFactory {

        /// <summary>
        /// Initializes a new instance of the <see cref="BrownClusterBigramFeatureGeneratorFactory"/> with the unique factory name.
        /// </summary>
        public BrownClusterBigramFeatureGeneratorFactory() : base("brownclusterbigram") { }
