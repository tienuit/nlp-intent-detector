...
namespace SharpNL.Utility.FeatureGen.Factories {
    ...
    /// </summary>
    public sealed class BrownClusterTokenFeatureGeneratorFactory : XmlFeatureGeneratorFactory {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlFeatureGeneratorFactory"/> with the unique factory name.
        /// </summary>
        public BrownClusterTokenFeatureGeneratorFactory() : base("brownclustertoken") {}
