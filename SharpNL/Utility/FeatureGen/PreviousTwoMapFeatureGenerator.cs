...
namespace SharpNL.Utility.FeatureGen {
    ...
    public class PreviousTwoMapFeatureGenerator : IAdaptiveFeatureGenerator {
        ...
        private readonly Dictionary<string, string> previousMap = new Dictionary<string, string>();
        ...
        public void CreateFeatures(List<string> features, string[] tokens, int index, string[] previousOutcomes) {
            if (index > 0) 
                features.Add("ppd=" + previousMap[tokens[index]] + "," + previousMap[tokens[index - 1]]);
